      ...
      <div className="flex items-center justify-center px-6 sm:px-8 py-10 sm:py-12 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mt-7 text-center text-sm text-gray-600">
            ...
            {/* LOTPLOT 22 — mention T&C remplace le lien sample deal.
                Le sample reste accessible depuis "Comment ça fonctionne". */}
            <p className="mt-3 text-xs text-gray-500">
              En vous inscrivant, vous acceptez nos{' '}
              <Link to="/terms" className="font-medium underline decoration-dotted hover:text-[#EA580C]">
